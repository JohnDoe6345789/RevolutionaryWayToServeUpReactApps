...
const { renderText, navigationButtons, systemTagsUnderTest, accessibility } =
...
describe("HeroSection", () => {
  ...
  it.each(systemTagsUnderTest)(
    "displays %s system tag as a chip",
    (systemTag: string) => {
      render(<HeroSection />);
  ...
  it("has proper accessibility attributes", () => {
    ...
    const heading = screen.getByRole("heading", {
      level: accessibility.headingLevel,
    });
