...
class BusinessLogicGenerator extends BaseCodegen {
  ...
  async initialize() {
    ...
    this.log('💼 Initializing business logic generator...', 'info');
...
// Replaced with: strings.getMessage('generatedproject')
  ...
  async generate(results) {
    this.log('🏭 Generating business logic classes...', 'info');
...
// Replaced with: strings.getConsole('no_business_logic_classes_specified')
      ...
      this.log(`✅ Generated ${this.generatedClasses.size} business logic classes`, 'success');
      
    } catch (error) {
      this.log(`❌ Business logic generation failed: ${error.message}`, 'error');
      throw error;
    }
  }
  ...
  async generateBusinessClass(classConfig) {
    this.log(`📝 Generating business class: ${classConfig.name}`, 'info');
...
`;
  ...
  async generateTypeScriptDefinitions() {
    this.log('📝 Generating TypeScript definitions...', 'info');
...
`;
  ...
  async generateTestStubs() {
    this.log('🧪 Generating test stubs...', 'info');
...
`;
  ...
  async generateClassIndex() {
    this.log('📋 Generating class index...', 'info');
