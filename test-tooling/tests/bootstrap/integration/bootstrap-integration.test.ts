/**
 * Integration tests for bootstrap helpers and functionality.
 */
...
describe("Bootstrap Integration", () => {
  ...
  describe("provider and module resolution", () => {
  ...
  describe("module collection and analysis", () => {
    ...
    it("deduplicates module specifiers while keeping first occurrence", () => {
      const source = `
        import { h } from "react";
  ...
  describe("require creation and module loading", () => {
  ...
  describe("local path resolution", () => {
    it("resolves module bases relative to current page location", () => {
      expect(
