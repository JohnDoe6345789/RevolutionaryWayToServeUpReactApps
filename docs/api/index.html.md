...
- **Loading order:** It pulls in `bootstrap/entrypoints/script-list-loader.js` (which in turn reads `bootstrap/entrypoints/script-list.html`), then finally `bootstrap.js` to launch the React components.
