  ...
  describe('validate', () => {
    ...
    describe('basic structure validation', () => {
      it.each([
        ...
        ['array spec', [], false, ['Missing required field: uuid', 'Missing required field: id', 'Missing required field: search']],
      ...
      it.each([
        ['empty object', {}, false, ['Missing required field: uuid', 'Missing required field: id', 'Missing required field: search']],
        ['only uuid', { uuid: '12345678-1234-4123-8123-123456789012' }, false, ['Missing required field: id', 'Missing required field: search']],
        ['only id', { id: 'test-id' }, false, ['Missing required field: uuid', 'Missing required field: search']],
        ['only search', { search: {} }, false, ['Missing required field: uuid', 'Missing required field: id']],
        ['uuid and id', { uuid: '12345678-1234-4123-8123-123456789012', id: 'test-id' }, false, ['Missing required field: search']],
        ['uuid and search', { uuid: '12345678-1234-4123-8123-123456789012', search: {} }, false, ['Missing required field: id']],
    ...
    describe('UUID validation', () => {
      ...
      it.each([
        ...
        ['invalid UUID - wrong format', '12345678-1234-4123-8123-12345678901', false, ['Invalid UUID format (must be RFC 4122)']],
        ['invalid UUID - no hyphens', '12345678123441238123123456789012', false, ['Invalid UUID format (must be RFC 4122)']],
        ['invalid UUID - wrong version', '12345678-1234-3123-8123-123456789012', false, ['Invalid UUID format (must be RFC 4122)']],
        ['invalid UUID - non-hex chars', 'gggggggg-gggg-gggg-gggg-gggggggggggg', false, ['Invalid UUID format (must be RFC 4122)']],
    ...
    describe('ID validation', () => {
      ...
      it.each([
        ...
        ['valid id with underscores', 'valid_id_name', false, ['Invalid ID format (must match pattern)']],
        ['valid id with dots', 'valid.id.name', true, []],
        ['invalid id - starts with hyphen', '-invalid', false, ['Invalid ID format (must match pattern)']],
        ['invalid id - starts with number', '1invalid', false, ['Invalid ID format (must match pattern)']],
        ['invalid id - uppercase', 'Invalid', false, ['Invalid ID format (must match pattern)']],
        ['invalid id - special chars', 'invalid@id', false, ['Invalid ID format (must match pattern)']],
    ...
    describe('search metadata validation', () => {
      ...
      it.each([
        ...
        ['array search', [], false, ['Missing required search field: title', 'Missing required search field: summary', 'Missing required search field: keywords']],
      ])('should reject invalid search metadata: %s', (description, search, expectedValid, expectedErrors) => {
      ...
      it.each([
        ['empty search object', {}, false, ['Missing required search field: title', 'Missing required search field: summary', 'Missing required search field: keywords']],
        ['only title', { title: 'Test' }, false, ['Missing required search field: summary', 'Missing required search field: keywords']],
        ['only summary', { summary: 'Test summary' }, false, ['Missing required search field: title', 'Missing required search field: keywords']],
        ['only keywords', { keywords: ['test'] }, false, ['Missing required search field: title', 'Missing required search field: summary']],
        ['title and summary', { title: 'Test', summary: 'Test summary' }, false, ['Missing required search field: keywords']],
        ['title and keywords', { title: 'Test', keywords: ['test'] }, false, ['Missing required search field: summary']],
        ['summary and keywords', { summary: 'Test summary', keywords: ['test'] }, false, ['Missing required search field: title']],
      ])('should reject incomplete search metadata: %s', (description, search, expectedValid, expectedErrors) => {
        const spec = { ...validSpecTemplate, search };
        const result = validator.validate(spec);
        expect(result.valid).toBe(expectedValid);
        if (!expectedValid) {
      ...
      it.each([
        ...
        ['undefined keywords', { title: 'Test', summary: 'Test summary', keywords: undefined }, true, []],
        ['string keywords', { title: 'Test', summary: 'Test summary', keywords: 'not an array' }, false, ['Search keywords must be an array']],
        ['number keywords', { title: 'Test', summary: 'Test summary', keywords: 42 }, false, ['Search keywords must be an array']],
        ['object keywords', { title: 'Test', summary: 'Test summary', keywords: {} }, false, ['Search keywords must be an array']],
        ['boolean keywords', { title: 'Test', summary: 'Test summary', keywords: true }, false, ['Search keywords must be an array']],
      ])('should validate keywords format: %s', (description, search, expectedValid, expectedErrors) => {
        const spec = { ...validSpecTemplate, search };
        const result = validator.validate(spec);
        expect(result.valid).toBe(expectedValid);
        if (!expectedValid) {
      ...
      it.each([
        ['valid minimal search', { title: 'Test', summary: 'Test summary', keywords: ['test'] }, true, []],
        ['valid full search', {
        ...
        ['empty keywords array', { title: 'Test', summary: 'Test summary', keywords: [] }, true, []],
        ['single keyword', { title: 'Test', summary: 'Test summary', keywords: ['single'] }, true, []],
      ])('should accept valid search metadata: %s', (description, search, expectedValid, expectedErrors) => {
        const spec = { ...validSpecTemplate, search };
        const result = validator.validate(spec);
        expect(result.valid).toBe(expectedValid);
        if (!expectedValid) {
